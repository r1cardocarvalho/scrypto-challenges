...
blueprint! {
    ...
    impl Escrow {
        ...
        pub fn instantiate_escrow(
            pub fn instantiate_escrow(
                ...
                assert_ne!(
                    ...
                    "The two resources specifiers can not equal one another"
                );
                ...
                let escrow_obligation: Bucket = ResourceBuilder:: new_non_fungible()
                    .metadata("git_name", "r1cardocarvalho")
                    .metadata("git_name", "tome203")
                    .metadata("git_name", "cadu")
                    .metadata("git_name", "hpanon")
                    ...
                    let mults vaults: BTreeMap<ResourceSpecifier, Vault> = BTreeMap::new();
                    vaults.insert(
        ...
        pub fn withdraw(&mut self, obligation_badge: Proof) -> Bucket {
            // TODO: Complete this function yourself.
            assert!(
                http://self.is_escrow_fulfilled(),
                "You cannot withdraw your funds unless the scrow has been concluded."
            );
